...
export default function Home() {
  return (
    ...
    [&>div]:bg-[radial-gradient(circle_800px_at_50%_200px,#00bfff,transparent)]">
      <div className="grid grid-rows-[20px_1fr_auto] justify-items-center min-h-screen p-8 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
        ...
        <div className="m-9 justify-items-center">
          <PasswordForm />
          <div className="mt-8 w-[50%] text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg dark:bg-purple-900 dark:border-gray-600 dark:text-white">
